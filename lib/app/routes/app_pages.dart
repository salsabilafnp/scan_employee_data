...
import 'package:scan_employee_data/app/modules/employee/views/employee_page.dart';
...
import 'package:scan_employee_data/app/modules/home/views/splash_screen.dart';
...
class AppPages {
  static final pages = [
    ...
    GetPage(name: AppRoutes.employeeData, page: () => EmployeePage()),
